...
| `extension_banner_dismissed` | bool | Whether the user has dismissed the Chrome extension install banner on Feed Memory — persisted in profile so dismissal is device-agnostic (default `False`) |
