  ...
  return (
    <div className="min-h-screen bg-background text-on-surface font-sans">
      ...
      <main>
        ...
        {/* ── Feature Cards ─────────────────────────────────────────────────── */}
        <section style={{ padding: "4rem 2rem", background: "#faf9f8" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>

            {/* Top row — two cards side by side */}
            <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: "1.5rem" }}>

              {/* Left — The Living Archive */}
              <div className="rounded-2xl bg-surface-container-low" style={{ padding: "2rem" }}>
                {/* Archive icon */}
                <div style={{ marginBottom: "1.25rem" }}>
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#58614f" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="21 8 21 21 3 21 3 8" />
                    <rect x="1" y="3" width="22" height="5" />
                    <line x1="10" y1="12" x2="14" y2="12" />
                  </svg>
                </div>
                <h3 className="font-headline" style={{ fontSize: "1.5rem", color: "#2f3333", marginBottom: "0.75rem", fontWeight: 400 }}>
                  The Living Archive
                </h3>
                <p style={{ fontSize: "0.95rem", color: "#645e57", lineHeight: 1.7, marginBottom: "1.5rem" }}>
                  Input any source — from PDFs to raw voice notes. Contendo indexes your unique world-view into a private semantic library.
                </p>
                {/* Dark decorative thumbnail with laurel wreath watermark */}
                <div
                  className="rounded-xl"
                  style={{
                    background: "linear-gradient(135deg, #2f3333 0%, #1a1f1a 100%)",
                    height: 120,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                >
                  <svg width="108" height="108" viewBox="0 0 100 100" fill="none" style={{ opacity: 0.06 }}>
                    <path d="M50 82 C42 76 30 68 22 56 C16 46 18 34 26 24" stroke="white" strokeWidth="1.2" />
                    <path d="M50 82 C58 76 70 68 78 56 C84 46 82 34 74 24" stroke="white" strokeWidth="1.2" />
                    <ellipse cx="24" cy="72" rx="7" ry="3" transform="rotate(-35 24 72)" stroke="white" strokeWidth="0.8" />
                    <ellipse cx="19" cy="58" rx="7" ry="3" transform="rotate(-52 19 58)" stroke="white" strokeWidth="0.8" />
                    <ellipse cx="20" cy="44" rx="7" ry="3" transform="rotate(-68 20 44)" stroke="white" strokeWidth="0.8" />
                    <ellipse cx="27" cy="32" rx="7" ry="3" transform="rotate(-80 27 32)" stroke="white" strokeWidth="0.8" />
                    <ellipse cx="37" cy="23" rx="7" ry="3" transform="rotate(-88 37 23)" stroke="white" strokeWidth="0.8" />
                    <ellipse cx="76" cy="72" rx="7" ry="3" transform="rotate(35 76 72)" stroke="white" strokeWidth="0.8" />
                    <ellipse cx="81" cy="58" rx="7" ry="3" transform="rotate(52 81 58)" stroke="white" strokeWidth="0.8" />
                    <ellipse cx="80" cy="44" rx="7" ry="3" transform="rotate(68 80 44)" stroke="white" strokeWidth="0.8" />
                    <ellipse cx="73" cy="32" rx="7" ry="3" transform="rotate(80 73 32)" stroke="white" strokeWidth="0.8" />
                    <ellipse cx="63" cy="23" rx="7" ry="3" transform="rotate(88 63 23)" stroke="white" strokeWidth="0.8" />
                    <path d="M44 84 L50 89 L56 84 M44 84 L40 88 M56 84 L60 88" stroke="white" strokeWidth="0.8" />
                    <path d="M40 22 Q50 16 60 22" stroke="white" strokeWidth="0.8" />
                  </svg>
                </div>
              </div>

              {/* Right — Endless Inspiration */}
              <div
                className="rounded-2xl"
                style={{ background: "#58614f", padding: "2rem", position: "relative", overflow: "hidden" }}
              >
                {/* Sparkle icon */}
                <div style={{ marginBottom: "1.25rem" }}>
                ...
                <h3 className="font-headline" style={{ fontSize: "1.5rem", color: "#ffffff", marginBottom: "0.75rem", fontWeight: 400 }}>
                  Endless Inspiration
                </h3>
                <p style={{ fontSize: "0.95rem", color: "rgba(255,255,255,0.75)", lineHeight: 1.7, marginBottom: "1.75rem" }}>
                ...
                {/* Large faint star — decorative, bottom-right */}
                <div
                  style={{
                    position: "absolute",
                    bottom: 8,
                ...
                {/* Laurel wreath watermark — references the embossed card aesthetic */}
                <div style={{ position: "absolute", top: "50%", right: "4%", transform: "translateY(-50%)", pointerEvents: "none" }}>
                  <svg width="110" height="110" viewBox="0 0 100 100" fill="none" style={{ opacity: 0.07 }}>
                    <path d="M50 82 C42 76 30 68 22 56 C16 46 18 34 26 24" stroke="white" strokeWidth="1.2" />
                    <path d="M50 82 C58 76 70 68 78 56 C84 46 82 34 74 24" stroke="white" strokeWidth="1.2" />
                    <ellipse cx="24" cy="72" rx="7" ry="3" transform="rotate(-35 24 72)" stroke="white" strokeWidth="0.8" />
                    <ellipse cx="19" cy="58" rx="7" ry="3" transform="rotate(-52 19 58)" stroke="white" strokeWidth="0.8" />
            ...
            {/* Third card — Refinement, Not Replacement (full width) */}
            <div className="rounded-2xl bg-surface-container-low" style={{ padding: "2rem", marginTop: "1.5rem" }}>
              <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: "2rem", alignItems: "center" }}>
                {/* Left column */}
                <div>
                  <div style={{ marginBottom: "1.25rem" }}>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#58614f" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <p style={{ fontSize: "0.95rem", color: "#645e57", lineHeight: 1.7 }}>
                    The AI acts as your editor — it checks tonal consistency against your voice profile and scores how well the draft resonates with your intended audience. Every suggestion is grounded in your own writing, not a template.
                  </p>
                </div>
                ...
                >
                  <p className="font-headline italic" style={{ fontSize: "1rem", color: "#2f3333", lineHeight: 1.7, marginBottom: "1.25rem" }}>
                    &ldquo;The scent of old paper and the hum of creation...&rdquo;
                  </p>
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    <div style={{ height: 8, borderRadius: 4, background: "#f3f4f3", width: "100%" }} />
                    <div style={{ height: 8, borderRadius: 4, background: "#f3f4f3", width: "82%" }} />
                  </div>
                </div>
              </div>
            </div>
