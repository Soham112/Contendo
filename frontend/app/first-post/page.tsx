...
export default function FirstPostPage() {
  ...
  async function handleGenerate() {
    ...
    // Save a partial profile so has_profile becomes true and the redirect loop stops.
    // roleLabel is used as `name` because profile_exists() checks the name field is non-empty.
    try {
      await api.saveProfile({
        name: finalAnswers.roleLabel || 'User',
